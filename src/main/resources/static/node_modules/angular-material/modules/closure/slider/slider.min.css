...
@
-webkit-keyframes sliderDiscreteFocusThumb { 0%{
	-webkit-transform: scale(.7);
	transform: scale(.7)
}
...
@
keyframes sliderDiscreteFocusThumb { 0%{
	-webkit-transform: scale(.7);
	transform: scale(.7)
}
...
@
-webkit-keyframes sliderDiscreteFocusRing { 0%{
	-webkit-transform: scale(.7);
	transform: scale(.7);
	opacity: 0
}
...
@
keyframes sliderDiscreteFocusRing { 0%{
	-webkit-transform: scale(.7);
	transform: scale(.7);
	opacity: 0
}
...
md-slider[md-discrete]:not ([disabled] ) ._md-slider-wrapper.md-focused ._md-focus-ring
	...
	transform: scale(0);
	-webkit-animation: sliderDiscreteFocusRing .5s
...
md-slider[md-discrete]:not ([disabled] ) ._md-slider-wrapper.md-focused ._md-thumb
	{
	-webkit-animation: sliderDiscreteFocusThumb .5s
		cubic-bezier(.35, 0, .25, 1);
...
md-slider[disabled] ._md-track-ticks, md-slider[disabled]:not ([readonly]
	) ._md-sign {
	opacity: 0
}
