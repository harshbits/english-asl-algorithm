...
@media ( min-width : 600px) and (max-width: 959px) {
	[hide]:not ([show-gt-xs] ):not ([show-sm] ):not ([show] ), [hide-gt-xs]:not
...
@media print {
	...
	[layout-align-print="start"], [layout-align-print="start start"], [layout-align-print="start center"],
		[layout-align-print="start end"], [layout-align-print="start stretch"]
		{
		-webkit-justify-content: flex-start;
		-ms-flex-pack: start;
		justify-content: flex-start;
	}
	[layout-align-print="center"], [layout-align-print="center start"], [layout-align-print="center center"],
		[layout-align-print="center end"], [layout-align-print="center stretch"]
		{
		-webkit-justify-content: center;
		-ms-flex-pack: center;
		justify-content: center;
	}
	[layout-align-print="end"], [layout-align-print="end center"], [layout-align-print="end start"],
		[layout-align-print="end end"], [layout-align-print="end stretch"] {
		-webkit-justify-content: flex-end;
		-ms-flex-pack: end;
		justify-content: flex-end;
	}
	[layout-align-print="space-around"], [layout-align-print="space-around center"],
		[layout-align-print="space-around start"], [layout-align-print="space-around end"],
	...
	[layout-align-print="space-between"], [layout-align-print="space-between center"],
		[layout-align-print="space-between start"], [layout-align-print="space-between end"],
		[layout-align-print="space-between stretch"] {
		-webkit-justify-content: space-between;
		-ms-flex-pack: justify;
		justify-content: space-between;
	}
	[layout-align-print="start start"], [layout-align-print="center start"],
		[layout-align-print="end start"], [layout-align-print="space-between start"],
	...
	[layout-align-print="start center"], [layout-align-print="center center"],
		[layout-align-print="end center"], [layout-align-print="space-between center"],
	...
	[layout-align-print="start end"], [layout-align-print="center end"], [layout-align-print="end end"],
		[layout-align-print="space-between end"], [layout-align-print="space-around end"]
		{
		-webkit-align-items: flex-end;
		-ms-flex-align: end;
		align-items: flex-end;
	...
	[layout-align-print="start stretch"], [layout-align-print="center stretch"],
		[layout-align-print="end stretch"], [layout-align-print="space-between stretch"],
		[layout-align-print="space-around stretch"] {
		-webkit-align-items: stretch;
		-ms-flex-align: stretch;
		align-items: stretch;
	...
	[layout="row"]>[flex-print="0"], [layout-print="row"]>[flex-print="0"] {
		-webkit-flex: 1 1 0%;
		-ms-flex: 1 1 0%;
		flex: 1 1 0%;
		max-width: 0%;
	...
	[layout="column"]>[flex-print="0"], [layout-print="column"]>[flex-print="0"]
		{
		-webkit-flex: 1 1 0%;
		-ms-flex: 1 1 0%;
		flex: 1 1 0%;
	...
	[layout="row"]>[flex-print="5"], [layout-print="row"]>[flex-print="5"] {
		-webkit-flex: 1 1 5%;
		-ms-flex: 1 1 5%;
		flex: 1 1 5%;
		max-width: 5%;
	...
	[layout="column"]>[flex-print="5"], [layout-print="column"]>[flex-print="5"]
		{
		-webkit-flex: 1 1 5%;
		-ms-flex: 1 1 5%;
		flex: 1 1 5%;
	...
	[layout="row"]>[flex-print="10"], [layout-print="row"]>[flex-print="10"]
		{
		-webkit-flex: 1 1 10%;
		-ms-flex: 1 1 10%;
		flex: 1 1 10%;
	...
	[layout="column"]>[flex-print="10"], [layout-print="column"]>[flex-print="10"]
		{
		-webkit-flex: 1 1 10%;
		-ms-flex: 1 1 10%;
		flex: 1 1 10%;
	...
	[layout="row"]>[flex-print="15"], [layout-print="row"]>[flex-print="15"]
		{
		-webkit-flex: 1 1 15%;
		-ms-flex: 1 1 15%;
		flex: 1 1 15%;
	...
	[layout="column"]>[flex-print="15"], [layout-print="column"]>[flex-print="15"]
		{
		-webkit-flex: 1 1 15%;
		-ms-flex: 1 1 15%;
		flex: 1 1 15%;
	...
	[layout="row"]>[flex-print="20"], [layout-print="row"]>[flex-print="20"]
		{
		-webkit-flex: 1 1 20%;
		-ms-flex: 1 1 20%;
		flex: 1 1 20%;
	...
	[layout="column"]>[flex-print="20"], [layout-print="column"]>[flex-print="20"]
		{
		-webkit-flex: 1 1 20%;
		-ms-flex: 1 1 20%;
		flex: 1 1 20%;
	...
	[layout="row"]>[flex-print="25"], [layout-print="row"]>[flex-print="25"]
		{
		-webkit-flex: 1 1 25%;
		-ms-flex: 1 1 25%;
		flex: 1 1 25%;
	...
	[layout="column"]>[flex-print="25"], [layout-print="column"]>[flex-print="25"]
		{
		-webkit-flex: 1 1 25%;
		-ms-flex: 1 1 25%;
		flex: 1 1 25%;
	...
	[layout="row"]>[flex-print="30"], [layout-print="row"]>[flex-print="30"]
		{
		-webkit-flex: 1 1 30%;
		-ms-flex: 1 1 30%;
		flex: 1 1 30%;
	...
	[layout="column"]>[flex-print="30"], [layout-print="column"]>[flex-print="30"]
		{
		-webkit-flex: 1 1 30%;
		-ms-flex: 1 1 30%;
		flex: 1 1 30%;
	...
	[layout="row"]>[flex-print="35"], [layout-print="row"]>[flex-print="35"]
		{
		-webkit-flex: 1 1 35%;
		-ms-flex: 1 1 35%;
		flex: 1 1 35%;
	...
	[layout="column"]>[flex-print="35"], [layout-print="column"]>[flex-print="35"]
		{
		-webkit-flex: 1 1 35%;
		-ms-flex: 1 1 35%;
		flex: 1 1 35%;
	...
	[layout="row"]>[flex-print="40"], [layout-print="row"]>[flex-print="40"]
		{
		-webkit-flex: 1 1 40%;
		-ms-flex: 1 1 40%;
		flex: 1 1 40%;
	...
	[layout="column"]>[flex-print="40"], [layout-print="column"]>[flex-print="40"]
		{
		-webkit-flex: 1 1 40%;
		-ms-flex: 1 1 40%;
		flex: 1 1 40%;
	...
	[layout="row"]>[flex-print="45"], [layout-print="row"]>[flex-print="45"]
		{
		-webkit-flex: 1 1 45%;
		-ms-flex: 1 1 45%;
		flex: 1 1 45%;
	...
	[layout="column"]>[flex-print="45"], [layout-print="column"]>[flex-print="45"]
		{
		-webkit-flex: 1 1 45%;
		-ms-flex: 1 1 45%;
		flex: 1 1 45%;
	...
	[layout="row"]>[flex-print="50"], [layout-print="row"]>[flex-print="50"]
		{
		-webkit-flex: 1 1 50%;
		-ms-flex: 1 1 50%;
		flex: 1 1 50%;
	...
	[layout="column"]>[flex-print="50"], [layout-print="column"]>[flex-print="50"]
		{
		-webkit-flex: 1 1 50%;
		-ms-flex: 1 1 50%;
		flex: 1 1 50%;
	...
	[layout="row"]>[flex-print="55"], [layout-print="row"]>[flex-print="55"]
		{
		-webkit-flex: 1 1 55%;
		-ms-flex: 1 1 55%;
		flex: 1 1 55%;
	...
	[layout="column"]>[flex-print="55"], [layout-print="column"]>[flex-print="55"]
		{
		-webkit-flex: 1 1 55%;
		-ms-flex: 1 1 55%;
		flex: 1 1 55%;
	...
	[layout="row"]>[flex-print="60"], [layout-print="row"]>[flex-print="60"]
		{
		-webkit-flex: 1 1 60%;
		-ms-flex: 1 1 60%;
		flex: 1 1 60%;
	...
	[layout="column"]>[flex-print="60"], [layout-print="column"]>[flex-print="60"]
		{
		-webkit-flex: 1 1 60%;
		-ms-flex: 1 1 60%;
		flex: 1 1 60%;
	...
	[layout="row"]>[flex-print="65"], [layout-print="row"]>[flex-print="65"]
		{
		-webkit-flex: 1 1 65%;
		-ms-flex: 1 1 65%;
		flex: 1 1 65%;
	...
	[layout="column"]>[flex-print="65"], [layout-print="column"]>[flex-print="65"]
		{
		-webkit-flex: 1 1 65%;
		-ms-flex: 1 1 65%;
		flex: 1 1 65%;
	...
	[layout="row"]>[flex-print="70"], [layout-print="row"]>[flex-print="70"]
		{
		-webkit-flex: 1 1 70%;
		-ms-flex: 1 1 70%;
		flex: 1 1 70%;
	...
	[layout="column"]>[flex-print="70"], [layout-print="column"]>[flex-print="70"]
		{
		-webkit-flex: 1 1 70%;
		-ms-flex: 1 1 70%;
		flex: 1 1 70%;
	...
	[layout="row"]>[flex-print="75"], [layout-print="row"]>[flex-print="75"]
		{
		-webkit-flex: 1 1 75%;
		-ms-flex: 1 1 75%;
		flex: 1 1 75%;
	...
	[layout="column"]>[flex-print="75"], [layout-print="column"]>[flex-print="75"]
		{
		-webkit-flex: 1 1 75%;
		-ms-flex: 1 1 75%;
		flex: 1 1 75%;
	...
	[layout="row"]>[flex-print="80"], [layout-print="row"]>[flex-print="80"]
		{
		-webkit-flex: 1 1 80%;
		-ms-flex: 1 1 80%;
		flex: 1 1 80%;
	...
	[layout="column"]>[flex-print="80"], [layout-print="column"]>[flex-print="80"]
		{
		-webkit-flex: 1 1 80%;
		-ms-flex: 1 1 80%;
		flex: 1 1 80%;
	...
	[layout="row"]>[flex-print="85"], [layout-print="row"]>[flex-print="85"]
		{
		-webkit-flex: 1 1 85%;
		-ms-flex: 1 1 85%;
		flex: 1 1 85%;
	...
	[layout="column"]>[flex-print="85"], [layout-print="column"]>[flex-print="85"]
		{
		-webkit-flex: 1 1 85%;
		-ms-flex: 1 1 85%;
		flex: 1 1 85%;
	...
	[layout="row"]>[flex-print="90"], [layout-print="row"]>[flex-print="90"]
		{
		-webkit-flex: 1 1 90%;
		-ms-flex: 1 1 90%;
		flex: 1 1 90%;
	...
	[layout="column"]>[flex-print="90"], [layout-print="column"]>[flex-print="90"]
		{
		-webkit-flex: 1 1 90%;
		-ms-flex: 1 1 90%;
		flex: 1 1 90%;
	...
	[layout="row"]>[flex-print="95"], [layout-print="row"]>[flex-print="95"]
		{
		-webkit-flex: 1 1 95%;
		-ms-flex: 1 1 95%;
		flex: 1 1 95%;
	...
	[layout="column"]>[flex-print="95"], [layout-print="column"]>[flex-print="95"]
		{
		-webkit-flex: 1 1 95%;
		-ms-flex: 1 1 95%;
		flex: 1 1 95%;
	...
	[layout="row"]>[flex-print="100"], [layout-print="row"]>[flex-print="100"]
		{
		-webkit-flex: 1 1 100%;
		-ms-flex: 1 1 100%;
		flex: 1 1 100%;
	...
	[layout="column"]>[flex-print="100"], [layout-print="column"]>[flex-print="100"]
		{
		-webkit-flex: 1 1 100%;
		-ms-flex: 1 1 100%;
		flex: 1 1 100%;
	...
	[layout="row"]>[flex-print="33"], [layout="row"]>[flex-print="33"], [layout-print="row"]>[flex-print="33"],
	...
	[layout="row"]>[flex-print="66"], [layout="row"]>[flex-print="66"], [layout-print="row"]>[flex-print="66"],
